...
public class SampleAspect {
	...
	// com.intheeast.aspectjsupport.declaringadvice.service.Sample+:
    ...
    @Before("execution(* com.intheeast.aspectjsupport.declaringadvice.service.Sample+.sampleGenericMethod(..)) && args(param, age, name)")
    public void beforeSampleMethodForDetermingArgumentName(JoinPoint joinPoint, MyType param, Integer age, String name) {
...
//    @Before("execution(* com.intheeast.aspectjsupport.declaringadvice.service.SampleService.*GenericMethod2(..)) && args(param)")
//    public void beforeSampleMethodForDetermingArgumentName2(JoinPoint joinPoint, MyType param) {
//
//    	MethodSignature methodSignature = (MethodSignature) joinPoint.getSignature();
//        Method method = methodSignature.getMethod();
//        
...
//        }
//
//        System.out.println("Before sampleGenericMethod2 with MyType param: " + param);
//    }
