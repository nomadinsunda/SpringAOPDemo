package com.intheeast.aspectjsupport.combindedpointcuts.pointcuts;
...
public class CommonPointcuts {
    ...
    @Pointcut("within(com.intheeast.aspectjsupport.combindedpointcuts.web..*)")
    public void inWebLayer() {}

    // 서비스 레이어의 모든 메서드를 매칭하는 포인트컷
    @Pointcut("within(com.intheeast.aspectjsupport.combindedpointcuts.service..*)")
    public void inServiceLayer() {}

    // DAO 레이어의 모든 메서드를 매칭하는 포인트컷
    @Pointcut("within(com.intheeast.aspectjsupport.combindedpointcuts.service.dao..*)")
    ...
    @Pointcut("execution(* com.intheeast.aspectjsupport.combindedpointcuts.service.*.*(..))")
    public void businessService() {}

    // DAO 레이어에 있는 데이터 액세스 메서드
    @Pointcut("execution(* com.intheeast.aspectjsupport.combindedpointcuts.service.dao.*.*(..))")
